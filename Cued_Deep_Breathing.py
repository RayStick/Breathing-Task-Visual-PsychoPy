...
# Instructions are displayed to the participant: Get Ready, Deep Breaths, Breathe Normally
# This script starts with a fixation then loops over the instructions a set amount of times
...
doRest = 2 # 0 = no rest; 1 = rest before CDB task; 2 = rest after CDB task
